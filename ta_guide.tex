...
% handed out by Samir Omerovic of the Institute of Structural Analysis at
% TU Graz.  
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[
...
\usepackage[latin1]{inputenc}           % coding of german special characters
...
\ifoot{\footnotesize{Finite Element Methode VA - Technischer Bericht}}
